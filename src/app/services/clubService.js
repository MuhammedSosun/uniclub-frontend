...
const clubService = {
  ...
  uploadLogoBase64: (data) => api.post("/clubs/logo/upload", data),
  ...
  getActiveClubsCount: () => api.get(`${CLUB_BASE}/count`),

  // ACTIVE PAGED
  getActiveClubsPaged: (params) => api.get(`${CLUB_BASE}/active/paged`, { params }),
