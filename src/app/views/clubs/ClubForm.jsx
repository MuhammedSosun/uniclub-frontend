...
export default function ClubForm({ initialValues, onSubmit, isEdit }) {
  ...
  const [formData, setFormData] = useState({
    clubName: "", shortName: "", description: "", logoUrl: "", 
    foundationDate: "", email: "", phone: "", instagram: "",
    approved: false, status: "ACTIVE", presidentId: "" 
  });
  ...
  useEffect(() => {
    if (initialValues) {
      setFormData({
        ...initialValues,
        approved: initialValues.approved === true || initialValues.approved === 'true' ? 'true' : 'false'
      });
    }
  }, [initialValues]);
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          <TextField
            ...
            variant="outlined"
            InputProps={{
                startAdornment: (<InputAdornment position="start"><AccountBalanceIcon color="action" /></InputAdornment>),
            }}
          />
        </Grid>
        ...
        {/* ALT GRUP: GÖRSEL VE TARİH BİLGİLERİ */}
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            variant="outlined"
            InputProps={{
                startAdornment: (<InputAdornment position="start"><DateRangeIcon color="action" /></InputAdornment>),
            }}
          />
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <TextField
            ...
            variant="outlined"
            InputProps={{
                startAdornment: (<InputAdornment position="start"><InstagramIcon color="action" /></InputAdornment>),
            }}
          />
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <MenuItem value="true" sx={{ color: 'success.main', fontWeight: 500 }}>✅ Onaylı (Aktif)</MenuItem>
            <MenuItem value="false" sx={{ color: 'error.main', fontWeight: 500 }}>❌ Onaysız (İncelemede)</MenuItem>
          </TextField>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <MenuItem value="ACTIVE" sx={{ color: 'success.main' }}>🟢 ACTIVE (Aktif Görünür)</MenuItem>
            <MenuItem value="SUSPENDED" sx={{ color: 'warning.main' }}>⏸️ SUSPENDED (Geçici Askıda)</MenuItem>
            <MenuItem value="TERMINATED" sx={{ color: 'error.main' }}>🚫 TERMINATED (Kapatıldı)</MenuItem>
            <MenuItem value="PRIVATE">🔒 PRIVATE (Sadece Üyelere Açık)</MenuItem>
            <MenuItem value="INCOMPLETED" sx={{ color: 'info.main' }}>📝 INCOMPLETED (Bilgiler Eksik)</MenuItem>
          </TextField>
        </Grid>
